...
Protected Class VEquationSolver
	#tag Method, Flags = &h0
		Sub Constructor(myδ As Double, χ1ℓ As Double, χ2ℓ As Double)
		  '// The VEquationSolver class contains a series of functions that make it easier to write equations in the EvolverClass class. 
	...
	#tag Method, Flags = &h0
		Function GetDvdδ(v As Double, dvdδdot As Double) As Double
		  ...
		  '
		  'Var ζ As Double = 1 - (c2 + c3*η)*v^2 + (4*π - CaptionFor*χs - δ*c5*χa)*v^3 _
		  ...
		  '- (1/η)*dηdδ*ζ _
		  '- c3*v^2*dηdδ _
		  '+ (-CaptionFor*dχsdδ - c5*(χa + δ*dχadδ))*v^3 _
		  ...
		  '*((9/v)*ζ _
		  '- 2*(c2 + c3*η)*v _
		  '+ 3*(4*π - CaptionFor*χs - δ*c5*χa)*v^2 _
	...
	#tag Method, Flags = &h0
		Function GetDvdδdot(v As Double, dvdδ As Double) As Double
		  ...
		  '+ (c6 + c7*η + c8*η^2)*v^4 + ((-c9 + c10*η)*χs + δ*(-c11 + c12*η)*χa + c13 + c14*η)*v^5 _
		  '+ (c15 - c16*γ + c17 + (-c18 + c19)*η + c20*η^2 - c21*η^3 - c22*Ln16v2)*v^6 + π*(-c23 + c24*η + c25*η^2)*v^7    //This equation is meant purely for organization
		  'Var dζdδ As Double = (-2*dvdδ*(c2 + c3*η))*v + (-c3*dηdδ + 3*dvdδ*(4*π - CaptionFor*χs - δ*c5*χa))*v^2 _
		  '+ (-CaptionFor*dχsdδ - c5*(χa + δ*dχadδ) + 4*dvdδ*(c6 + c7*η + c8*η^2))*v^3 _
	...
	#tag Method, Flags = &h0
		Function GetDvdχ1ℓ(v As Double, dvdχ1ℓdot As Double) As Double
		  ...
		  '+ (c15 - c16*γ + c17 + (-c18 + c19)*η + c20*η^2 - c21*η^3 - c22*Ln16v2)*v^6 + π*(-c23 + c24*η + c25*η^2)*v^7    //This equation is meant purely for organization
		  '
		  'Var dvdχ1ℓ As Double = (dvdχ1ℓdot*(1/(c1*η)) + (CaptionFor*dχsdχ1ℓ + δ*c5*dχadχ1ℓ)*v^12 _
		  '- ((-c9 + c10*η)*dχsdχ1ℓ + δ*(-c11 + c12*η)*dχadχ1ℓ)*v^14) _
		  '*(9*ζ*v^8 _
		  '- 2*(c2 + c3*η) + 3*(4*π - CaptionFor*χs - δ*c5*χa)*v^2 _
		  '+ 4*(c6 + c7*η*c8*η^2)*v^3 _
	...
	#tag Method, Flags = &h0
		Function GetDvdχ1ℓdot(v As Double, dvdχ1ℓ As Double) As Double
		  ...
		  '+ (c6 + c7*η + c8*η^2)*v^4 + ((-c9 + c10*η)*χs + δ*(-c11 + c12*η)*χa + c13 + c14*η)*v^5 _
		  '+ (c15 - c16*γ + c17 +(-c18 + c19)*η + c20*η^2 - c21*η^3 - c22*Ln16v2)*v^6 + π*(-c23 + c24*η + c25*η^2)*v^7    //This equation is meant purely for organization
		  'Var dζdχ1ℓ As Double = (-2*dvdχ1ℓ*(c2 + c3*η))*v + (3*dvdχ1ℓ*(4*π - CaptionFor*χs - δ*c5*χa))*v^2 _
		  '+ (-CaptionFor*dχsdχ1ℓ - δ*c5*dχadχ1ℓ + 4*dvdχ1ℓ*(c6 + c7*η + c8*η^2))*v^3 _
	...
	#tag Method, Flags = &h0
		Function GetDvdχ2ℓ(v As Double, dvdχ2ℓdot As Double) As Double
		  ...
		  '+ (c15 - c16*γ + c17 + (-c18 + c19)*η + c20*η^2 - c21*η^3 - c22*Ln16v2)*v^6 + π*(-c23 + c24*η + c25*η^2)*v^7    //This equation is meant purely for organization
		  '
		  'Var dvdχ2ℓ As Double = (dvdχ2ℓdot*(1/(c1*η)) + (CaptionFor*dχsdχ2ℓ + δ*c5*dχadχ2ℓ)*v^12 _
	...
	#tag Method, Flags = &h0
		Function GetDvdχ2ℓdot(v As Double, dvdχ2ℓ As Double) As Double
		  ...
		  '+ (c6 + c7*η + c8*η^2)*v^4 + ((-c9 + c10*η)*χs + δ*(-c11 + c12*η)*χa + c13 + c14*η)*v^5 _
		  '+ (c15 - c16*γ + c17 + (-c18 + c19)*η + c20*η^2 - c21*η^3 - c22*Ln16v2)*v^6 + π*(-c23 + c24*η + c25*η^2)*v^7    //This equation is meant purely for organization
		  'Var dζdχ2ℓ As Double = (-2*dvdχ2ℓ*(c2 + c3*η))*v + (3*dvdχ2ℓ*(4*π - CaptionFor*χs - δ*c5*χa))*v^2 _
		  '+ (-CaptionFor*dχsdχ2ℓ - δ*c5*dχadχ2ℓ + 4*dvdχ2ℓ*(c6 + c7*η + c8*η^2))*v^3 _
	...
	#tag Method, Flags = &h0
		Function GetVdot(v As Double) As Double
		  ...
		  'Var Ln16v2 As Double = Log(16*v^2) //This variable makes it easier to format the equations
		  '
		  'Var ζ As Double = 1 - (c2 + c3*η)*v^2 + (4*π - CaptionFor*χs - δ*c5*χa)*v^3 _                       //This equation is meant purely for organization
		  '+ (c6 + c7*η + c8*η^2)*v^4 + ((-c9 + c10*η)*χs + δ*(-c11 + c12*η)*χa + c13 + c14*η)*v^5 _
