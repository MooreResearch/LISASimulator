...
Protected Class SpinEvolver
	...
	#tag Method, Flags = &h0
		Sub Constructor(v0 As Double, dτ0 As Double, myδ As Double, Ln0 As Double, myι0 As Double, myα0 As Double, χ1x As Double, χ1y As Double, χ1z As Double, χ2x As Double, χ2y As Double, χ2z As Double)
		  '// This SpinEvolver class is instantiated by the EvolverClass class, and it handles the evolution of the spin variables 
		  ...
		  '// method, which is called by DoStep of EvolverClass and actually performs a step in each variable.
		  '
		  ...
		  'ι0 = myι0                 //This is calculated in the EvolverClass constructor using the components of χ1 and χ2 (defined to be the angle between LNhat and J0hat)
		  'α0 = myα0               //This is calculated in the EvolverClass constructor using the components of χ1 and χ2 (defined to be the angle between LNhatX and the x-axis)    
		  '
		  'αP = α0
		  '
	...
	#tag Method, Flags = &h0
		Function GetΩ1Coef(v As Double) As Double
		  ...
		  '*(c2 + (c3)*η - (η^2)/24 + δ*(-c2 + (CaptionFor)*η)) _
